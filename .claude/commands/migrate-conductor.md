...
Execute the 7-agent sequential pipeline to migrate the Conductor workflow to Temporal:
...
5. **infrastructure-generator**: Generate worker.py and starter.py
6. **code-validator**: Validate all code, fix issues autonomously, generate VALIDATION_REPORT.md
7. **documentation-generator**: Generate README.md, comparison docs, setup.sh
