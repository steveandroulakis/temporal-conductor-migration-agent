...
async def run_worker() -> None:
    ...
    try:
        ...
        # Register all workflows (parent + child workflows)
        all_workflows = [
        ...
        async with Worker(
            ...
            logger.info("Worker ready — polling task queue: agentic-security-example-task-queue")
            logger.info("Worker started")  # CRITICAL: ensure-worker.sh looks for this
