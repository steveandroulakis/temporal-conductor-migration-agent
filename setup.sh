...
echo "======================================"
echo ""
echo "Setting up: Insurance Claim Processing Workflow"
echo ""
...
echo "   uv run starter"
echo ""
echo "4. Interact with the running workflow:"
echo "   # Get workflow ID from starter output, then:"
echo "   uv run interact update <workflow-id> submit_claim '{...}'"
echo "   uv run interact query <workflow-id> get_status"
echo ""
echo "5. Monitor in Web UI:"
