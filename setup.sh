...
echo "======================================"
echo "  CheckAddress Temporal Workflow Setup"
echo "======================================"
echo ""
echo "Setting up: USPS Address Validation Workflow"
echo ""
...
echo ""
echo "NOTE: This workflow uses MOCK data for USPS API."
echo "      See README for known valid addresses and OAuth migration notes."
echo ""
