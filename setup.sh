...
echo "   uv run starter"
echo ""
echo "4. Interact with workflow (get workflow ID from step 3):"
echo "   uv run interact query <workflow-id> get_cart_status"
echo "   uv run interact update <workflow-id> update_cart '{\"cart\": \"shopping\", \"cart_items\": \"item1, item2\"}'"
echo ""
